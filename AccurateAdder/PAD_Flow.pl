...
$modname = "Adder"; #should be modified 
...
$clkname = "clock";  #should be modified 
$period = 10;
...
$instance = "test/ADD0";  #should be modified 
$netlist = "./SYNTH/run_s/${modname}_final.v";
$libname = "NangateOpenCellLibrary_PDKv1_2_v2008_10_typical_conditional_nldm";
$libpath = "/home/pxs/synopsys/NANgate_library";
...
EOM
	...
	# dimensions that are a multiple of the standard cell height                ############********************this part is deleted in WangChen edition
...
#	reportTA -nworst  10 -net > ${modname}_timing_trialroute.rpt
	...
	#timeDesign -reportonly -numPaths  10 -outDir ${modname}_timing_extracted_trialroute
    	timeDesign -postroute -reportonly -numPaths  10 -outDir ${modname}_timing_extracted_trialroute	
...
if($power_op == 1 ) {
	...
	report_clock_tree_power > ${modname}_clock_pwr_base.rpt
	report_timing > ${modname}_timing_base.rpt
